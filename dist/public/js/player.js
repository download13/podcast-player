...
(function (global, factory) {
	 true ? module.exports = factory(__webpack_require__(2), __webpack_require__(28)) :
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = seekRelative;
/* harmony export (immutable) */ __webpack_exports__["a"] = seekToPosition;
...
/* harmony export (immutable) */ __webpack_exports__["b"] = getEpisode;
/* harmony export (immutable) */ __webpack_exports__["a"] = getCurrentEpisode;
/* unused harmony export getNextEpisode */
/* unused harmony export getPreviousEpisode */


function getEpisode(state, index) {
  return state.episodes[index] || __WEBPACK_IMPORTED_MODULE_0__index__["b" /* initialEpisodeInfo */];
}
...
function getNextEpisode(state, episode) {
  var nextIndex = episode.index + 1;
...
function getPreviousEpisode(state, episode) {
  var index = episode.index - 1;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_file_cache__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__store_selectors__ = __webpack_require__(7);
/* harmony export (immutable) */ __webpack_exports__["b"] = keepEpisodesCached;
/* harmony export (immutable) */ __webpack_exports__["a"] = ensureEpisodeCached;
/* harmony export (immutable) */ __webpack_exports__["c"] = getCachedEpisodeState;



function keepEpisodesCached(store, state$, episodes$) {
  var cacheCommand$ = state$.pluck('cacheCommand').filter(function (cmd) {
    return !!cmd;
  }).distinctUntilChanged();

  cacheCommand$.subscribe(function (_ref) {
    var type = _ref.type,
        index = _ref.payload;

    var episode = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__store_selectors__["b" /* getEpisode */])(state$.getValue(), index);
    ...
    if (type === 'cache') {
      ensureEpisodeCached(episode).subscribe(function (progress) {
      ...
      deleteEpisode(episode).then(function () {
...
function ensureEpisodeCached(episode) {
  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__common_file_cache__["a" /* ensureFileCached */])(episode.imageUrl).ignoreElements().concat(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__common_file_cache__["a" /* ensureFileCached */])(episode.audioUrl));
}

function deleteEpisode(episode) {
  return Promise.all([__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__common_file_cache__["b" /* deleteCachedFile */])(episode.imageUrl), __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__common_file_cache__["b" /* deleteCachedFile */])(episode.audioUrl)]);
}

function cleanupOtherEpisodes(episodes) {
  return deleteSelectedFiles(function (fileUrl) {
...
function getCachedEpisodeState(episodes) {
  var state = episodes.map(function (episode) {
    return {
      shouldCache: false,
      progress: 0
    };
  ...
  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__common_file_cache__["c" /* listCachedFiles */])().then(function (files) {
    return files.filter(function (url) {
      if (url.endsWith('/audio')) {
        var match = url.match(/episodes\/([0-9]+)\/audio$/);
        return match && match[1];
      }
      return false;
    }).map(function (url) {
      var index = parseInt(url.match(/episodes\/([0-9]+)\/audio$/)[1]);
      return index;
    });
  }).then(function (cachedIndexes) {
    cachedIndexes.forEach(function (index) {
      var episode = state[index];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__selectors__ = __webpack_require__(7);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return initialEpisodeInfo; });
  ...
  switch (type) {
    ...
    case 'SELECT_EPISODE':
      if (payload >= 0 && payload < state.episodes.length) {
        return _extends({}, state, { selectedIndex: payload });
      } else {
        return state;
      }
    case 'FLUSH_SELECTED_EPISODE':
      return _extends({}, state, { index: state.selectedIndex });
    case 'RESET_SELECTED_EPISODE':
      return _extends({}, state, { selectedIndex: index });
    case 'CHANGE_VOLUME':
    ...
    case 'SET_EPISODE_CACHE_PROGRESS':
      var episode = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__selectors__["b" /* getEpisode */])(state, payload.index);

      return _extends({}, state, {
        episodes: replaceElement(state.episodes, payload.index, _extends({}, episode, {
    ...
    case 'SHOW_BOOKMARKS':
      return _extends({}, state, { showingBookmarks: true });
    case 'HIDE_BOOKMARKS':
      return _extends({}, state, { showingBookmarks: false });
    case 'SHOW_EPISODES':
      return _extends({}, state, { showingEpisodes: true });
    case 'HIDE_EPISODES':
      return _extends({}, state, { showingEpisodes: false });
    case 'SET_BOOKMARKS':
      if (Array.isArray(payload)) {
        return _extends({}, state, { bookmarks: payload });
      }
      return state;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_distinctUntilChanged__ = __webpack_require__(68);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_operator_share__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_do__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_do___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_do__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_pluck__ = __webpack_require__(72);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_add_operator_filter__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_add_operator_filter___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_rxjs_add_operator_filter__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_rxjs_add_operator_throttleTime__ = __webpack_require__(73);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_rxjs_add_observable_fromEvent__ = __webpack_require__(66);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_rxjs_add_observable_combineLatest__ = __webpack_require__(65);
...
/* harmony export (immutable) */ __webpack_exports__["a"] = storeObservable;
...
function storeObservable(store) {
  var state$ = new __WEBPACK_IMPORTED_MODULE_1_rxjs_BehaviorSubject__["BehaviorSubject"](store.getState());
...
var Observable_1 = __webpack_require__(0);
var do_1 = __webpack_require__(83);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_preact_redux__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__player__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__bookmarks__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__episodes__ = __webpack_require__(43);
...
var Holder = function Holder(_ref) {
  var showingBookmarks = _ref.showingBookmarks,
      showingEpisodes = _ref.showingEpisodes;

  var showingPlayer = !showingBookmarks && !showingEpisodes;

  var bookmarks = showingBookmarks ? __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_3__bookmarks__["a" /* default */], null) : undefined;
  var episodes = showingEpisodes ? __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_4__episodes__["a" /* default */], null) : undefined;
  ...
  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
      'div',
      { style: showingStyle(showingPlayer) },
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_2__player__["a" /* default */], null)
    ),
    bookmarks,
    episodes
  );
...
/* harmony default export */ __webpack_exports__["a"] = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_preact_redux__["connect"])(function (state) {
  return state;
}, function (dispatch) {
  return {};
})(Holder);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cache__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__browser__ = __webpack_require__(46);
/* harmony export (immutable) */ __webpack_exports__["a"] = syncStoreToStorage;
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
function syncStoreToStorage(store) {
  var rawState$ = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__common__["a" /* storeObservable */])(store);

  var state$ = rawState$.distinctUntilChanged().share();

  var podcastName$ = state$.pluck('podcastName').distinctUntilChanged().share();

  var episodes$ = state$.pluck('episodes').distinctUntilChanged().share();

  var bookmarks$ = state$.pluck('bookmarks').distinctUntilChanged();

  var throttledPosition$ = state$.pluck('uiPosition').distinctUntilChanged().throttleTime(5000);

  var paused$ = state$.pluck('playing').distinctUntilChanged().filter(function (playing) {
    return !playing;
  });

  __WEBPACK_IMPORTED_MODULE_0__common__["b" /* Observable */].combineLatest(state$, throttledPosition$, paused$, __WEBPACK_IMPORTED_MODULE_0__common__["b" /* Observable */].fromEvent(window, 'beforeunload')).subscribe(function (_ref) {
    var _ref2 = _slicedToArray(_ref, 1),
        state = _ref2[0];

    return savePlaceToStorage(state);
  });

  __WEBPACK_IMPORTED_MODULE_0__common__["b" /* Observable */].combineLatest(podcastName$, bookmarks$).subscribe(function (_ref3) {
  ...
  __WEBPACK_IMPORTED_MODULE_0__common__["b" /* Observable */].combineLatest(podcastName$, episodes$).subscribe(function (_ref5) {
    var _ref6 = _slicedToArray(_ref5, 2),
        podcastName = _ref6[0],
        episodes = _ref6[1];

    return saveEpisodesToStorage(podcastName, episodes);
  });

  var state = store.getState();

  loadEpisodesFromServer(state.podcastName).then(function () {
  ...
  loadBookmarksFromServer(state.podcastName).then(function () {
    return loadBookmarksFromStorage(store);
  });

  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__browser__["a" /* syncTitle */])(state$);
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__browser__["b" /* mediaSessionControls */])(store, state$);
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__browser__["c" /* playerKeyControls */])(store);
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__cache__["b" /* keepEpisodesCached */])(store, rawState$, episodes$);
}
...
function loadCachedEpisodeState(store) {
  ...
  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__cache__["c" /* getCachedEpisodeState */])(episodes).then(function (progresses) {
    var newEpisodes = episodes.map(function (episode, i) {
...
function loadEpisodesFromServer(podcastName) {
  return fetch('/p/' + podcastName + '/list').then(function (res) {
    return res.json();
  }).then(publicEpisodes.bind(null, podcastName)).then(function (episodes) {
...
function savePlaceToStorage(state) {
  var podcastName = state.podcastName,
      index = state.index,
...
function loadEpisodesFromStorage(store) {
  ...
  var episodes = get(podcastName, 'episodes');
...
function loadPlaceFromStorage(store) {
  ...
  var loadedState = get(podcastName, 'place');
...
function loadBookmarksFromStorage(store) {
  ...
  var bookmarks = get(podcastName, 'bookmarks');
...
function get(podcastName, type) {
  if (podcastName) {
    var json = localStorage.getItem(podcastName + '_' + type);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_range_parser__ = __webpack_require__(57);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pure__ = __webpack_require__(40);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_do__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_do___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_do__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_ignoreElements__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_ignoreElements___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_ignoreElements__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_add_operator_concat__ = __webpack_require__(67);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ensureFileCached; });
/* harmony export (immutable) */ __webpack_exports__["c"] = listCachedFiles;
/* harmony export (immutable) */ __webpack_exports__["b"] = deleteCachedFile;
...
function asyncCacheForSameArgument(fn) {
  ...
  return function (arg) {
    ...
    var asyncResult = fn(arg).do(null, null, function () {
      return pending.delete(arg);
    }).share();
...
var ensureFileCached = asyncCacheForSameArgument(function (url) {
  return __WEBPACK_IMPORTED_MODULE_2_rxjs_Observable__["Observable"].create(function (observer) {
    var done = false;

    observer.next(0);

    ensureFileInfoCached(url).then(function (_ref) {
...
/* harmony default export */ __webpack_exports__["a"] = AudioComponent;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_preact_redux__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_preact_redux___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_preact_redux__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__store_actions__ = __webpack_require__(6);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var Bookmark = function Bookmark(_ref) {
  var index = _ref.index,
      ...
      position = _ref.position,
      gotoBookmark = _ref.gotoBookmark,
  ...
  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
      ...
      episode + 1,
      ' - ',
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__common__["b" /* formatTime */])(position)
    ),
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
      'button',
      { onClick: gotoBookmark, 'class': 'lean-right' },
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])('span', { 'class': 'icon-play' })
    ),
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
      'button',
      { onClick: deleteBookmark },
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])('span', { 'class': 'icon-trash-empty' })
    )
  );
};

var Bookmarks = function Bookmarks(_ref2) {
  var bookmarks = _ref2.bookmarks,
      hideBookmarks = _ref2.hideBookmarks,
      createBookmark = _ref2.createBookmark,
      _deleteBookmark = _ref2.deleteBookmark,
      _gotoBookmark = _ref2.gotoBookmark;
  ...
  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
        'button',
        { 'class': 'back', title: 'Back to Player', onClick: hideBookmarks },
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])('span', { 'class': 'icon-play' })
      ),
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
        'button',
        { onClick: createBookmark, 'class': 'lean-right' },
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])('span', { 'class': 'icon-plus-squared' })
      )
    ),
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
      'div',
      ...
      bookmarks.map(function (bookmark, i) {
        return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(Bookmark, _extends({}, bookmark, {
          key: i,
          index: i,
...
/* harmony default export */ __webpack_exports__["a"] = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_preact_redux__["connect"])(function (state) {
  ...
  return {
    hideBookmarks: function hideBookmarks() {
    ...
    gotoBookmark: function gotoBookmark(bookmark) {
      ...
      dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__store_actions__["a" /* seekToPosition */])(bookmark.position));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_preact_redux__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_preact_redux___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_preact_redux__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__store_actions__ = __webpack_require__(6);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var Episode = function Episode(_ref) {
  var cacheProgress = _ref.cacheProgress,
      title = _ref.title,
      deleteEpisode = _ref.deleteEpisode,
      cacheEpisode = _ref.cacheEpisode,
      playEpisode = _ref.playEpisode;

  var button = void 0;
  if (cacheProgress === 1) {
    button = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
      'button',
    ...
    button = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])('span', { 'class': 'icon-download-cloud' })
    );
...
var Episodes = function (_Component) {
  ...
  function Episodes() {
    ...
    var _this = _possibleConstructorReturn(this, (_ref2 = Episodes.__proto__ || Object.getPrototypeOf(Episodes)).call.apply(_ref2, [this].concat(args)));

    _this.readyToScroll = true;
    return _this;
  }
  ...
  _createClass(Episodes, [{
    ...
    value: function render(_ref3) {
      ...
      var index = _ref3.index,
          episodes = _ref3.episodes,
          hideEpisodes = _ref3.hideEpisodes,
          _deleteEpisode = _ref3.deleteEpisode,
          _cacheEpisode = _ref3.cacheEpisode,
          _playEpisode = _ref3.playEpisode;

      var scrollIndex = Math.max(index - 1, 0);
      ...
      return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
          ...
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
            'button',
            { 'class': 'back', title: 'Back to Player', onClick: hideEpisodes },
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])('span', { 'class': 'icon-play' })
          )
        ),
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
          ...
          episodes.map(function (episode) {
            var episodeEl = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(Episode, _extends({}, episode, {
              deleteEpisode: function deleteEpisode() {
                return _deleteEpisode(episode.index);
              },
              cacheEpisode: function cacheEpisode() {
                return _cacheEpisode(episode.index);
              },
              playEpisode: function playEpisode() {
                return _playEpisode(episode.index);
              }
            }));
            ...
            if (scrollIndex === episode.index) {
              return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
                'div',
                { key: episode.index, ref: function ref(el) {
                    return _this2.selectedEpisodeEl = el;
                  } },
                episodeEl
              );
            }
...
/* harmony default export */ __webpack_exports__["a"] = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_preact_redux__["connect"])(function (state) {
  ...
  return {
    hideEpisodes: function hideEpisodes() {
      dispatch({ type: 'HIDE_EPISODES' });
    },
    playEpisode: function playEpisode(index) {
      dispatch({ type: 'SELECT_EPISODE', payload: index });
      dispatch({ type: 'FLUSH_SELECTED_EPISODE' });
      dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__store_actions__["a" /* seekToPosition */])(0));
      dispatch({ type: 'CHANGE_PLAYING', payload: true });
      dispatch({ type: 'HIDE_EPISODES' });
    },
    cacheEpisode: function cacheEpisode(index) {
      dispatch({
    ...
    deleteEpisode: function deleteEpisode(index) {
      dispatch({
        type: 'SEND_CACHE_COMMAND',
        payload: {
          type: 'delete',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_preact__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_preact___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_preact__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__podcast_image__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__audio__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_preact_redux__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_debounce__ = __webpack_require__(48);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__common__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__store_actions__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__store_selectors__ = __webpack_require__(7);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var Player = function Player(_ref) {
  var selectedIndex = _ref.selectedIndex,
      ...
      showEpisodes = _ref.showEpisodes,
      showBookmarks = _ref.showBookmarks;
  ...
  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
        'a',
        { 'class': 'back button', title: 'Back to Podcasts', href: '/' },
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])('span', { 'class': 'icon-play' })
      ),
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
        'h1',
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
        'button',
        { title: 'Bookmarks', onClick: showBookmarks, style: { marginLeft: 'auto' } },
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])('span', { 'class': 'icon-bookmark' })
      ),
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
        'button',
        { title: 'Episodes', onClick: showEpisodes },
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])('span', { 'class': 'icon-menu' })
      )
    ),
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
        'div',
        { 'class': 'time' },
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__common__["b" /* formatTime */])(uiPosition) + ' / ' + __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__common__["b" /* formatTime */])(duration)
      )
    ),
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
      'div',
...
/* harmony default export */ __webpack_exports__["a"] = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3_preact_redux__["connect"])(function (state) {
  return _extends({}, state, {
    episode: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__store_selectors__["a" /* getCurrentEpisode */])(state)
  });
}, function (dispatch) {
  return {
    ...
    seekScrubbedTo: function seekScrubbedTo(e) {
      ...
      dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__store_actions__["a" /* seekToPosition */])(position));
    },
    ...
    seekBackward5: function seekBackward5() {
      dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__store_actions__["b" /* seekRelative */])(-5));
    },
    seekBackward30: function seekBackward30() {
      dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6__store_actions__["b" /* seekRelative */])(-30));
    },
    ...
    showEpisodes: function showEpisodes() {
...
/* harmony default export */ __webpack_exports__["a"] = PodcastImage;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__store_selectors__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__store_actions__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common__ = __webpack_require__(22);
/* harmony export (immutable) */ __webpack_exports__["a"] = syncTitle;
/* harmony export (immutable) */ __webpack_exports__["b"] = mediaSessionControls;
/* harmony export (immutable) */ __webpack_exports__["c"] = playerKeyControls;




function syncTitle(state$) {
  state$.map(__WEBPACK_IMPORTED_MODULE_0__store_selectors__["a" /* getCurrentEpisode */]).distinctUntilChanged().subscribe(function (episode) {
    var title = episode.title,
        imageUrl = episode.imageUrl;
...
function mediaSessionControls(store, state$) {
  if (navigator.mediaSession) {
    ...
    navigator.mediaSession.setActionHandler('seekbackward', function () {
      store.dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__store_actions__["b" /* seekRelative */])(-5));
    });
    ...
    state$.subscribe(function (state) {
      var _getCurrentEpisode = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__store_selectors__["a" /* getCurrentEpisode */])(state),
...
function playerKeyControls(store) {
  __WEBPACK_IMPORTED_MODULE_2__common__["b" /* Observable */].fromEvent(window, 'keyup').filter(function (e) {
    return e.code === 'Space';
...
var Observable_1 = __webpack_require__(0);
var ignoreElements_1 = __webpack_require__(85);
...
var Observable_1 = __webpack_require__(0);
var pluck_1 = __webpack_require__(88);
...
var Observable_1 = __webpack_require__(0);
var throttleTime_1 = __webpack_require__(91);
...
var multicast_1 = __webpack_require__(87);
var Subject_1 = __webpack_require__(11);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(19), __webpack_require__(105)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_preact_redux__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_holder__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__plugins_storage__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__plugins_cache__ = __webpack_require__(20);
...
window.store = store;
window.ensureEpisodeCached = __WEBPACK_IMPORTED_MODULE_6__plugins_cache__["a" /* ensureEpisodeCached */];
...
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_preact__["render"])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_preact__["h"])(
  ...
  { store: store },
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_preact__["h"])(__WEBPACK_IMPORTED_MODULE_4__components_holder__["a" /* default */], null)
